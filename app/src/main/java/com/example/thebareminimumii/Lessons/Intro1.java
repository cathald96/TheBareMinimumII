...
public class Intro1 extends AppCompatActivity implements ValueEventListener {
    TextView textView2,textView3,textView4,textView5,textView6,textView7,textView8,textView9,textView10;
    ImageView image;
    private Dialog loadingDialog;
    private FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
    private DatabaseReference databaseReference =firebaseDatabase.getReference("Intro1");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new Dialog(Intro1.this);
