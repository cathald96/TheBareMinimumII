...
public class ClassesQuestionsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new Dialog(ClassesQuestionsActivity.this);
    ...
    {
        questionList = new ArrayList<>();
        firestore.collection("Quiz").document("Classes")
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(ClassesQuestionsActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
    ...
    private void changeQuestion()
    {
        if(qNum<questionList.size()-1)
        {
        ...
        else if(String.valueOf(score).equals(String.valueOf(questionList.size()))&& counter<=8){
            counter = 8;
            ...
            Intent intent = new Intent(ClassesQuestionsActivity.this, ScoreActivity.class);
            intent.putExtra("SCORE",String.valueOf(score)+"/"+String.valueOf(questionList.size()));
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            startActivity(intent);
            ClassesQuestionsActivity.this.finish();
