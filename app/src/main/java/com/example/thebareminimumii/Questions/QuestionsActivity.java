...
public class QuestionsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    {
       questionList = new ArrayList<>();
       firestore.collection("Quiz").document("Introduction")
    ...
    private void changeQuestion()
    {
       ...
       else if(String.valueOf(score).equals(String.valueOf(questionList.size()))&&counter<1){
           counter = 1;
          MenuCount counter = new MenuCount(Menu.counter);
           // database =FirebaseDatabase.getInstance();
           // databaseName =database.getReference("Users");
           // FirebaseUser currentFirebaseUser = FirebaseAuth.getInstance().getCurrentUser() ;
           // int counter1 = MenuCount.getCounter();
            //databaseName.child(String.valueOf(counter1)).push();
