...
public class SortingQuestionsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new Dialog(SortingQuestionsActivity.this);
    ...
    {
        questionList = new ArrayList<>();
        firestore.collection("Quiz").document("Sorting")
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(SortingQuestionsActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
    ...
    private void changeQuestion()
    {
        if(qNum<questionList.size()-1)
        {
        ...
        else if(String.valueOf(score).equals(String.valueOf(questionList.size()))&& counter<=7){
            counter = 7;
            ...
            Intent intent = new Intent(SortingQuestionsActivity.this, ScoreActivity.class);
            intent.putExtra("SCORE",String.valueOf(score)+"/"+String.valueOf(questionList.size()));
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            startActivity(intent);
            SortingQuestionsActivity.this.finish();
